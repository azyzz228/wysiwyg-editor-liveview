...
#
#     PHX_SERVER=true bin/editor start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :editor, EditorWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :editor, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  s3_secret_access_key =
    System.get_env("S3_SECRET_ACCESS_KEY") ||
      raise """
      S3 Secret Access key is missing
      """
